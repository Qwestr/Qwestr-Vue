<template>
  <v-container>
    ...
    <app-qwest-edit-dialog v-if="isQwestLoaded"></app-qwest-edit-dialog>
...
export default {
  components: {
    'app-qwest-create-dialog': QwestCreateDialog,
    'app-qwest-edit-dialog': QwestEditDialog,
    'app-qwest-list': QwestList
  },
  computed: {
    isQwestLoaded () {
