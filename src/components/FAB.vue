<template>
  <div>
    ...
    <v-fab-transition>
      <v-speed-dial
        v-show="fab.id === 'SubQwestDetailsFAB'"
        fixed
        bottom
        right
        v-model="fab.dial"
      >
        ...
        <v-btn
          ...
          small
          color="orange"
          @click="toggleSubQwestDetailsEditMode"
        >
          <v-icon>edit</v-icon>
        </v-btn>
      </v-speed-dial>
